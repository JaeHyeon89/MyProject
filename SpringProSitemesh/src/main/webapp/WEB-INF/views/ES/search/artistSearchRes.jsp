	  ...
	  <div class="container-fluid">
	    <div style="font-size: 25px;">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="active"><a href="/springPro/search/artist?search=${ search }">아티스트</a></li> 
...
<c:choose>
	<c:when test="${ size>0 }">
	<div class="row">
			<c:forEach var="each" begin="${ pbean.startNum }" end="${ pbean.endNum }" items="${ artistListc }">
				<div class="col-sm-6">
					<hr>
					<div class="row">
						<!-- 아티스트사진 -->
						<div class="col-sm-4">
							<a onClick="location.href='/springPro/albumInfo?name=${each.artistName}'"
