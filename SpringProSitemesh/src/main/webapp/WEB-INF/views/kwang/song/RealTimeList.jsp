...
<script>
	function checkAll3() {
		...
		if (checkbox.length) {
			for (var i = 0; checkbox.length; i++) {
				checkbox[i].checked = frm3.all.checked;
			}
		} else {
			checkbox.checked = frm3.all.checked;
		}
	}

	function goCheckPlay3() {
	...
	function goSong3(){	//노래 구매 function
...
<form name="frm3">
	...
	<button type="button" class="btn btn-success" onclick="goCheckPlay3()">선택듣기</button>
	<input type="button" class="btn btn-success" value="선택담기"> 
	<button type="button" class="btn btn-success" 
				<c:if test="${nowLogon!=null}">onclick="goSong3()"</c:if>
	...
	<div class="container-fluid">
		<c:forEach var="each" items="${ listr }" varStatus="status">
				<div class="row">
				...
				<div class="col-md-2">
					...
					<div class="row">
						<div class="col-md-2">
							<br> <label><input type="checkbox" name="num" id="check3"
